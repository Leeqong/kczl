...
public class evaluationService {
	...
	public String upload(String schoolnumber,String effect,String arrangement,String attendance,String speed,String content,String ctid,String starttime,String endtime) {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("arrangement", arrangement));	
